...
function InitModule(ctx: nkruntime.Context, logger: nkruntime.Logger, nk: nkruntime.Nakama, initializer: nkruntime.Initializer): void {
  ...
  // Register user chips RPC functions (update_chips intentionally not registered — clients cannot mint)
  ...
  // Create career leaderboard at boot so authoritative hand writes never miss it
